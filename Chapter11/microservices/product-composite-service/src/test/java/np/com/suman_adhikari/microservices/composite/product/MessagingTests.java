package np.com.suman_adhikari.microservices.composite.product;
...
import static np.com.suman_adhikari.api.event.Event.Type.CREATE;
import static np.com.suman_adhikari.api.event.Event.Type.DELETE;
import static np.com.suman_adhikari.microservices.composite.product.IsSameEvent.sameEventExceptCreatedAt;
...
import np.com.suman_adhikari.api.composite.product.ProductAggregate;
import np.com.suman_adhikari.api.composite.product.RecommendationSummary;
import np.com.suman_adhikari.api.composite.product.ReviewSummary;
...
import np.com.suman_adhikari.api.event.Event;
